...
type Writer interface {
	WriteSignInPage(rw http.ResponseWriter, req *http.Request, redirectURL string, statusCode int, provider providers.Provider)
...
func (w *WriterFuncs) WriteSignInPage(rw http.ResponseWriter, req *http.Request, redirectURL string, statusCode int, provider providers.Provider) {
	if w.SignInPageFunc != nil {
		w.SignInPageFunc(rw, req, redirectURL, statusCode, provider)
		return
	}
