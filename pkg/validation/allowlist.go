...
func validateAllowlists(o *options.AlphaOptions) []string {
	...
	if len(o.Server.TrustedIPs) > 0 && o.Server.ReverseProxy {
...
func validateAuthRoutes(o *options.AlphaOptions) []string {
	msgs := []string{}
	for _, route := range o.Server.SkipAuthRoutes {
		var regex string
...
func validateAPIRoutes(o *options.AlphaOptions) []string {
	return validateRegexes(o.Server.APIRoutes)
}
